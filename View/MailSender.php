...
class MailSender{
    ...
    $this->_mailer->Username = 'raefet.jlidi@esprit.tn';  // SMTP username
    $this->_mailer->Password = '201JMT3619';  // SMTP password



    $this->_mailer->addReplyTo("raefet.jlidi@esprit.tn", "Galaxy");
    $this->_mailer->From = 'raefet.jlidi@esprit.tn';
    $this->_mailer->FromName = 'Galaxy Invaders';
...
// HTML email body
        ...
        $body .= "<thead>
						<tr height='80'>
							<th colspan='4' style='background-color:#f5f5f5; border-bottom:solid 1px #bdbdbd; font-family:Verdana, Geneva, sans-serif; color:#333; font-size:34px;'>Galaxy Invaders</th>
						</tr>
						</thead>";
        ...
        $body .= "<tbody>
						...
						<tr>
							<td colspan='4' style='padding:15px;'>
								<p style='font-size:20px;'>Hello ,  ". $this->_name."</p>
