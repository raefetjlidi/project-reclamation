...
$nomUtilisateur = null; 
if (!empty($_GET['id'])) { $nomUtilisateur = $_REQUEST['id']; } if (null == $nomUtilisateur) { header("location:afficherListeReclamation.php"); } else { 
...
<html lang="en">
	...
	<meta name="viewport" content="wnomUtilisateurth=device-wnomUtilisateurth, initial-scale=1">
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="../assets/assets-dashboard/images/favicon.png">
    <!-- Custom Stylesheet -->
	<link href="../assets/assets-dashboard/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">
    <link href="../assets/assets-dashboard/css/style.css" rel="stylesheet">
    </head>
       ...
       ***********************************-->
       <div class="nav-header">
           <a href="index.html" class="brand-logo">
               <svg class="logo-abbr" wnomUtilisateurth="55" height="55" viewbox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                       ...
                       <ul class="navbar-nav header-right">
                           <li class="nav-item d-flex align-items-center">
                               <div class="input-group search-area">
                                   ...
                                   <span class="input-group-text"><a href="javascript:vonomUtilisateur(0)"><i class="flaticon-381-search-2"></i></a></span>
                               </div>
                           </li>
                           <li class="nav-item dropdown notification_dropdown">
                               <a class="nav-link " href="javascript:vonomUtilisateur(0);">
                                   <svg wnomUtilisateurth="28" height="28" viewbox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <li class="nav-item dropdown notification_dropdown">
                               <a class="nav-link" href="javascript:vonomUtilisateur(0);" role="button" data-bs-toggle="dropdown">
                                   <svg wnomUtilisateurth="28" height="28" viewbox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                               ...
                               <div class="dropdown-menu dropdown-menu-end">
                                   <div nomUtilisateur="DZ_W_Notification1" class="wnomUtilisateurget-media dlab-scroll p-3" style="height:380px;">
                                       <ul class="timeline">
                                           <li>
                                               <div class="timeline-panel">
                                                   <div class="media me-2">
                                                       <img alt="image" wnomUtilisateurth="50" src="images/avatar/1.jpg">
                                                   </div>
                                   ...
                                   <a class="all-notification" href="javascript:vonomUtilisateur(0);">See all notifications <i class="ti-arrow-end"></i></a>
                               </div>
                           </li>
                           <li class="nav-item dropdown notification_dropdown">
                               <a class="nav-link bell-link " href="javascript:vonomUtilisateur(0);">
                               <svg wnomUtilisateurth="28" height="28" viewbox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <li class="nav-item dropdown notification_dropdown">
                               <a class="nav-link " href="javascript:vonomUtilisateur(0);" data-bs-toggle="dropdown">
                                   <svg wnomUtilisateurth="28" height="28" viewbox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                               ...
                               <div class="dropdown-menu dropdown-menu-end">
                                   <div nomUtilisateur="DZ_W_TimeLine02" class="wnomUtilisateurget-timeline dlab-scroll style-1 ps ps--active-y p-3 height370">
                                       <ul class="timeline">
                                           <li>
                                               <div class="timeline-badge primary"></div>
                                               <a class="timeline-panel text-muted" href="javascript:vonomUtilisateur(0);">
                                                   <span>10 minutes ago</span>
                                                   <h6 class="mb-0">Youtube, a vnomUtilisateureo-sharing website, goes live <strong class="text-primary">$500</strong>.</h6>
                                               </a>
                                           </li>
                                           <li>
                           ...
                           <li class="nav-item dropdown  header-profile">
                               <a class="nav-link" href="javascript:vonomUtilisateur(0);" role="button" data-bs-toggle="dropdown">
                                   <img src="images/user.jpg" wnomUtilisateurth="56" alt="">
                               </a>
                               <div class="dropdown-menu dropdown-menu-end">
                                   <a href="app-profile.html" class="dropdown-item ai-icon">
                                       <svg nomUtilisateur="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" wnomUtilisateurth="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-wnomUtilisateurth="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                       <span class="ms-2">Profile </span>
                                   </a>
                                   <a href="email-inbox.html" class="dropdown-item ai-icon">
                                       <svg nomUtilisateur="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" wnomUtilisateurth="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-wnomUtilisateurth="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                       <span class="ms-2">Inbox </span>
                                   </a>
                                   <a href="page-error-404.html" class="dropdown-item ai-icon">
                                       <svg nomUtilisateur="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger" wnomUtilisateurth="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-wnomUtilisateurth="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
